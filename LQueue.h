...
class Queue
{
 public:
  ...
  void move_to_front(QueueElement x);
  /*-----------------------------------------------------------------------
    Moves node to front of queue (if found).

    Precondition:  Queue is nonempty.
    Postcondition: Node which contains the value is moved to the front 
	               of the queue unless the queue does not contain the 
				   given value.
  -----------------------------------------------------------------------*/
...
void merge_two_queues(Queue & q);
  /*-----------------------------------------------------------------------
    ...
    Precondition:  Both queues must be sorted before.
    Postcondition: Queue has all the elements and the given Queue 
				   is empty.
  -----------------------------------------------------------------------*/
